    ...
    this.books = [
      {
        ...
        subtitle: 'Grundlagen, fortgeschrittene Themen und Best Practices -mit NativeScript und NgRx', rating: 5, thumbnails: [{ url: 'https://ng-buch.de/buch1.jpg', title: 'Buchcover' }], description: 'Die Autoren führen Sie mit einem → anspruchsvollen Beispielprojekt durch die Welt von → Angular...'
      },
      {
        isbn: '9783864903274', 
